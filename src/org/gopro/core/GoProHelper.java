...
public class GoProHelper {
	...
	public CamFields getCameraSettings() throws Exception {
		try {
			byte[] arrayOfByte =
					sendGET(this.mCameraAddress + "/camera/se" + "?t=" + this.getToken());
	...
	public CamFields getCameraSettingsExtended() {
		...
		try {
			byte[] arrayOfByte =
					sendGET(this.mCameraAddress + Operations.CAMERA_SX + "?t=" + this.getToken());
			localGoProProtocolParser = new GoProProtocolParser(arrayOfByte);
		...
		localHashMap
				.put("camera/SS", Short.valueOf(localGoProProtocolParser.extractUnsignedByte()));
		localHashMap
				.put("camera/BU", Short.valueOf(localGoProProtocolParser.extractUnsignedByte()));
		localHashMap
				.put("camera/CS", Short.valueOf(localGoProProtocolParser.extractUnsignedByte()));
		localHashMap
				.put("camera/WB", Short.valueOf(localGoProProtocolParser.extractUnsignedByte()));
		localHashMap
				.put("camera/BR", Short.valueOf(localGoProProtocolParser.extractUnsignedByte()));
		localHashMap
				.put("camera/PN", Short.valueOf(localGoProProtocolParser.extractUnsignedByte()));
		localHashMap
				.put("camera/LO", Short.valueOf(localGoProProtocolParser.extractUnsignedByte()));
		localHashMap
				.put("camera/PS", Short.valueOf(localGoProProtocolParser.extractUnsignedByte()));
		localHashMap
				.put("camera/BX", Short.valueOf(localGoProProtocolParser.extractUnsignedByte()));
		localHashMap
				.put("camera/TS", Short.valueOf(localGoProProtocolParser.extractUnsignedByte()));
		...
		localHashMap
				.put("camera/LV", Short.valueOf(localGoProProtocolParser.extractUnsignedByte()));
		localHashMap
				.put("camera/LN", Short.valueOf(localGoProProtocolParser.extractUnsignedByte()));
		localHashMap
				.put("camera/LS", Short.valueOf(localGoProProtocolParser.extractUnsignedByte()));
		localHashMap
				.put("camera/VV", Short.valueOf(localGoProProtocolParser.extractUnsignedByte()));
		localHashMap
				.put("camera/FS", Short.valueOf(localGoProProtocolParser.extractUnsignedByte()));
		return localCamFields;
	}
